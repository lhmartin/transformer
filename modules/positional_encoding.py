...
class SinCosPositionalEmbedding(nn.Module):
    def __init__(self, model_dimension: int):
        ...
        pos_vector = arange(0, self.max_sequence_length).unsqueeze(1)
        ...
        pos_embedings = zeros(self.max_sequence_length, model_dimension)
...
if __name__ == "__main__":
    SinCosPositionalEmbedding(model_dimension=16)
